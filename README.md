...
Training is implemented using PyTorch, and the detailed code can be found in the repository folder named '[Deep learning MODEL]([FRP_Prediction/Deep Learning Model](https://github.com/dazhaxie666/FRP_Prediction/tree/main/Deep%20Learning%20Model)'.
